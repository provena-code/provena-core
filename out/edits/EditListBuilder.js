import { COPY_EVENT_TYPE, EDIT_EVENT_TYPE } from "./event-types";
...
class AttributionConfig {
    ...
    */
    removeRedundantTextChanges = true, 
    /** Minimum length of matching text to consider when removing redundant text changes. */
    minRedundantTextLength = 3, minHistoricalMatchOverlapRatio = 0.2, minHistoricalMatchLongestOverlapRatio = 0.05) {
        this.userEditThreshold = userEditThreshold;
        this.removeRedundantTextChanges = removeRedundantTextChanges;
        this.minRedundantTextLength = minRedundantTextLength;
        this.minHistoricalMatchOverlapRatio = minHistoricalMatchOverlapRatio;
        this.minHistoricalMatchLongestOverlapRatio = minHistoricalMatchLongestOverlapRatio;
    }
}
export var DocumentStatus;
(function (DocumentStatus) {
    DocumentStatus[DocumentStatus["Synced"] = 0] = "Synced";
    DocumentStatus[DocumentStatus["Modified"] = 1] = "Modified";
    DocumentStatus[DocumentStatus["Irreconcilable"] = 2] = "Irreconcilable";
})(DocumentStatus || (DocumentStatus = {}));
export class EditListBuilder {
    get lastCopiedText() {
        return this.copiedText?.text;
    }
    constructor(editList, config = new AttributionConfig()) {
        this.editList = editList;
        this.config = config;
        this.copiedText = null;
    }
    getAuthor(edits, isUndoOrRedo) {
        if (isUndoOrRedo) {
    ...
    verifyDocumentText(documentText, time, update) {
    ...
    resetText(documentText, time, author = Author.ExternalEdit) {
     ...
     */
    removeRedundantTextChanges(changeEvent) {
...
//# sourceMappingURL=EditListBuilder.js.map